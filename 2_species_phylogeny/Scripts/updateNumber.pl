...
# set variables
$proteome = 'combined_proteomes.faa'; # the proteome file
$markerscanner = @ARGV[0]; # location of MarkerScanner script
$output = 'Scripts/MarkerScanner.pl'; # location of MarkerScanner final script
